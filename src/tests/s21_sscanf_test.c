...
// Спецификатор i - знаковое целое число (может быть десятичным, восьмеричным
...
START_TEST(sscanf_test_all) {
  ...
  r2 = s21_sscanf("4 123 amogus678q 12e34", "%i%d%9s%c%e", &i2, &d2, s2, &c2,
                  &e2);
  ck_assert_int_eq(i1, i2);
  ck_assert_int_eq(d1, d2);
  ck_assert_str_eq(s1, s2);
  ck_assert_int_eq(c1, c2);
  ck_assert_double_eq_tol(e1, e2, 1e-06);
  ck_assert_int_eq(r1, r2);

  r1 = sscanf("4 123 amogus678q 12e34 43e21", "%i%d%9s%c%e%E", &i1, &d1, s1,
              &c1, &e1, &E1);
  r2 = s21_sscanf("4 123 amogus678q 12e34 43e21", "%i%d%9s%c%e%E", &i2, &d2, s2,
                  &c2, &e2, &E2);
  ck_assert_int_eq(i1, i2);
  ck_assert_int_eq(d1, d2);
  ck_assert_str_eq(s1, s2);
  ...
  r1 = sscanf("4 123 amogus678q 12e34 43e21 13.37", "%i%d%9s%c%e%E%f", &i1, &d1,
              s1, &c1, &e1, &E1, &f1);
  r2 = s21_sscanf("4 123 amogus678q 12e34 43e21 13.37", "%i%d%9s%c%e%E%f", &i2,
                  &d2, s2, &c2, &e2, &E2, &f2);
  ...
  ck_assert_msg(g1 == g2, "floats not quals");
  ck_assert_int_eq(r1, r2);

  r1 =
      sscanf("4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228",
             "%i%d%9s%c%e%E%f%g%G", &i1, &d1, s1, &c1, &e1, &E1, &f1, &g1, &G1);
  r2 = s21_sscanf("4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228",
  ...
  r1 = sscanf("4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101",
              "%i%d%9s%c%e%E%f%g%G%o", &i1, &d1, s1, &c1, &e1, &E1, &f1, &g1,
              &G1, &o1);
  r2 = s21_sscanf("4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101",
  ...
  r1 = sscanf("4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101 1854",
              "%i%d%9s%c%e%E%f%g%G%o%u", &i1, &d1, s1, &c1, &e1, &E1, &f1, &g1,
              &G1, &o1, &u1);
  r2 = s21_sscanf("4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101 1854",
  ...
  r1 = sscanf("4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101 1854 12ab",
              ...
              &g1, &G1, &o1, &u1, &x1);
  r2 = s21_sscanf(
      "4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101 1854 12ab",
  ...
  r1 = sscanf(
      "4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101 1854 12ab BA21",
  ...
  r1 = sscanf(
      "4 123 amogus678q 12e34 43e21 13.37 2.28 1337.228 101 1854 12ab BA21 "
      "shrek & amogus is sus?",
      "%i%d%9s%c%e%E%f%g%G%o%u%x%X%n%%", &i1, &d1, s1, &c1, &e1, &E1, &f1, &g1,
      &G1, &o1, &u1, &x1, &X1, &n1);
  r2 = s21_sscanf(
      "4 123 amogus678q 12e34 43e21 13.37 2.28 "
      "1337.228 101 1854 12ab BA21 shrek & amogus is sus?",
      "%i%d%9s%c%e%E%f%g%G%o%u%x%X%n%%", &i2, &d2, s2, &c2, &e2, &E2, &f2, &g2,
      &G2, &o2, &u2, &x2, &X2, &n2);
...
START_TEST(sscanf_n1) {
  ...
  const char fstr[BUFF_SIZE] = "%lli %lli %n %lli";

  int16_t res1 = s21_sscanf(str, fstr, &a1, &b1, &n1, &c1);
  int16_t res2 = sscanf(str, fstr, &a2, &b2, &n2, &c2);
...
Suite *sscanf_suite(void) {
  Suite *s21_string = suite_create("s21_sscanf_test");
  TCase *tc_sscanf = tcase_create("s21_sscanf");

  tcase_add_test(tc_sscanf, s21_sscanf_c_test);
  tcase_add_test(tc_sscanf, s21_sscanf_s_test);
  tcase_add_test(tc_sscanf, s21_sscanf_d_test);
  tcase_add_test(tc_sscanf, s21_sscanf_i_test);
  tcase_add_test(tc_sscanf, s21_sscanf_o_test);
  tcase_add_test(tc_sscanf, s21_sscanf_u_test);
  tcase_add_test(tc_sscanf, s21_sscanf_xX_test);
  tcase_add_test(tc_sscanf, s21_sscanf_p_test);
  tcase_add_test(tc_sscanf, s21_sscanf_n_test);
  tcase_add_test(tc_sscanf, s21_sscanf_percent_test);
  tcase_add_test(tc_sscanf, s21_sscanf_asterisk_test);
  tcase_add_test(tc_sscanf, s21_sscanf_test);
  tcase_add_test(tc_sscanf, sscanf_test_d);
  tcase_add_test(tc_sscanf, sscanf_test_n);
  tcase_add_test(tc_sscanf, sscanf_test_p);
  tcase_add_test(tc_sscanf, sscanf_test_proc);
  tcase_add_test(tc_sscanf, sscanf_test_i);
  tcase_add_test(tc_sscanf, sscanf_test_x);
  tcase_add_test(tc_sscanf, sscanf_test_o);
  tcase_add_test(tc_sscanf, sscanf_test_f);
  tcase_add_test(tc_sscanf, sscanf_test_s);
  tcase_add_test(tc_sscanf, sscanf_test_h);
  tcase_add_test(tc_sscanf, sscanf_test_u);
  tcase_add_test(tc_sscanf, sscanf_test_L);
  tcase_add_test(tc_sscanf, sscanf_test_l);
  tcase_add_test(tc_sscanf, sscanf_test_e);
  tcase_add_test(tc_sscanf, sscanf_test_all);
  tcase_add_test(tc_sscanf, sscanf_EOF1);
  tcase_add_test(tc_sscanf, sscanf_EOF2);
  tcase_add_test(tc_sscanf, sscanf_EOF3);
  tcase_add_test(tc_sscanf, sscanf_only_chars1);
  tcase_add_test(tc_sscanf, sscanf_only_chars2);
  tcase_add_test(tc_sscanf, sscanf_only_chars3);
  tcase_add_test(tc_sscanf, sscanf_only_chars4);
  tcase_add_test(tc_sscanf, sscanf_only_chars5);
  tcase_add_test(tc_sscanf, sscanf_special_symbols_as_chars1);
  tcase_add_test(tc_sscanf, sscanf_special_symbols_as_chars2);
  tcase_add_test(tc_sscanf, sscanf_special_symbols_as_chars3);

  tcase_add_test(tc_sscanf, sscanf_chars_flags1);
  tcase_add_test(tc_sscanf, sscanf_chars_flags2);
  tcase_add_test(tc_sscanf, sscanf_chars_flags3);
  tcase_add_test(tc_sscanf, sscanf_chars_flags4);
  tcase_add_test(tc_sscanf, sscanf_chars_flags5);
  tcase_add_test(tc_sscanf, sscanf_chars_aster1);
  tcase_add_test(tc_sscanf, sscanf_chars_aster2);

  tcase_add_test(tc_sscanf, sscanf_only_ints1);
  tcase_add_test(tc_sscanf, sscanf_only_ints2);
  tcase_add_test(tc_sscanf, sscanf_only_ints3);

  tcase_add_test(tc_sscanf, sscanf_ints_nwidth1);
  tcase_add_test(tc_sscanf, sscanf_ints_nwidth2);
  tcase_add_test(tc_sscanf, sscanf_ints_nwidth3);
  tcase_add_test(tc_sscanf, sscanf_ints_nwidth4);

  tcase_add_test(tc_sscanf, sscanf_ints_astwidth1);
  tcase_add_test(tc_sscanf, sscanf_ints_astwidth2);
  tcase_add_test(tc_sscanf, sscanf_ints_astwidth3);
  tcase_add_test(tc_sscanf, sscanf_ints_astwidth4);

  tcase_add_test(tc_sscanf, sscanf_signed_ints1);
  tcase_add_test(tc_sscanf, sscanf_signed_ints4);

  tcase_add_test(tc_sscanf, sscanf_spec_i_int1);
  tcase_add_test(tc_sscanf, sscanf_spec_i_int2);

  tcase_add_test(tc_sscanf, sscanf_spec_i_int3);
  tcase_add_test(tc_sscanf, sscanf_spec_i_int4);

  tcase_add_test(tc_sscanf, sscanf_spec_i_oct1);
  tcase_add_test(tc_sscanf, sscanf_spec_i_oct2);
  tcase_add_test(tc_sscanf, sscanf_spec_i_hex1);
  tcase_add_test(tc_sscanf, sscanf_spec_i_hex2);

  tcase_add_test(tc_sscanf, sscanf_strings1);
  tcase_add_test(tc_sscanf, sscanf_strings2);
  tcase_add_test(tc_sscanf, sscanf_strings3);
  tcase_add_test(tc_sscanf, sscanf_strings4);
  tcase_add_test(tc_sscanf, sscanf_strings5);
  tcase_add_test(tc_sscanf, sscanf_strings6);
  tcase_add_test(tc_sscanf, sscanf_uint1);
  tcase_add_test(tc_sscanf, sscanf_uint2);
  tcase_add_test(tc_sscanf, sscanf_uint3);
  tcase_add_test(tc_sscanf, sscanf_uint4);
  tcase_add_test(tc_sscanf, sscanf_uint5);
  tcase_add_test(tc_sscanf, sscanf_uint6);
  tcase_add_test(tc_sscanf, sscanf_strings_mixed1);
  tcase_add_test(tc_sscanf, sscanf_strings_mixed2);
  tcase_add_test(tc_sscanf, sscanf_strings_mixed3);

  tcase_add_test(tc_sscanf, sscanf_floats1);
  tcase_add_test(tc_sscanf, sscanf_floats2);
  //  tcase_add_test(tc_sscanf, sscanf_floats3);
  tcase_add_test(tc_sscanf, sscanf_floats4);
  tcase_add_test(tc_sscanf, sscanf_floats5);

  tcase_add_test(tc_sscanf, sscanf_floats_sci1);
  tcase_add_test(tc_sscanf, sscanf_floats_sci2);
  tcase_add_test(tc_sscanf, sscanf_floats_sci3);
  tcase_add_test(tc_sscanf, sscanf_floats_sci4);
  tcase_add_test(tc_sscanf, sscanf_floats_sci5);

  tcase_add_test(tc_sscanf, sscanf_n1);
  tcase_add_test(tc_sscanf, sscanf_n2);
  tcase_add_test(tc_sscanf, sscanf_n3);
  tcase_add_test(tc_sscanf, sscanf_n4);
  tcase_add_test(tc_sscanf, sscanf_n5);

  tcase_add_test(tc_sscanf, sscanf_upeer_hex_base_version);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_overflow);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_0x);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_0X);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_empty);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_fail);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_spaces_tabs_sns);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_short);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_long);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_longlong);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_2x);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_star);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_nohex);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_lower);
  tcase_add_test(tc_sscanf, sscanf_upeer_hex_sign);
  tcase_add_test(tc_sscanf, upper_hex_len);

  tcase_add_test(tc_sscanf, sscanf_lower_hex_base_version);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_overflow);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_0x);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_0X);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_empty);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_fail);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_spaces_tabs_sns);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_short);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_long);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_longlong);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_2x);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_star);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_nohex);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_lower);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_sign);
  tcase_add_test(tc_sscanf, sscanf_lower_hex_len);

  tcase_add_test(tc_sscanf, sscanf_octal_base_version);
  tcase_add_test(tc_sscanf, sscanf_octal_0x);
  tcase_add_test(tc_sscanf, sscanf_octal_0X);
  tcase_add_test(tc_sscanf, sscanf_octal_empty);
  tcase_add_test(tc_sscanf, sscanf_octal_fail);
  tcase_add_test(tc_sscanf, sscanf_octal_spaces_tabs_sns);
  tcase_add_test(tc_sscanf, sscanf_octal_short);
  tcase_add_test(tc_sscanf, sscanf_octal_long);
  tcase_add_test(tc_sscanf, sscanf_octal_longlong);
  tcase_add_test(tc_sscanf, sscanf_octal_nohex);
  tcase_add_test(tc_sscanf, sscanf_octal_lower);
  tcase_add_test(tc_sscanf, sscanf_octal_sign);
  tcase_add_test(tc_sscanf, sscanf_octal_len);

  tcase_add_test(tc_sscanf, sscanf_pointer1);
  tcase_add_test(tc_sscanf, sscanf_pointer2);
  tcase_add_test(tc_sscanf, sscanf_pointer3);
  tcase_add_test(tc_sscanf, sscanf_pointer4);

  tcase_add_test(tc_sscanf, sscanf_buff1);
  tcase_add_test(tc_sscanf, sscanf_buff2);
  tcase_add_test(tc_sscanf, sscanf_buff3);

  tcase_add_test(tc_sscanf, sscanf_perc1);
  tcase_add_test(tc_sscanf, sscanf_perc2);
  tcase_add_test(tc_sscanf, sscanf_perc3);
  tcase_add_test(tc_sscanf, sscanf_perc5);

  tcase_add_test(tc_sscanf, sscanf_mixed_ptrs1);
  tcase_add_test(tc_sscanf, sscanf_mixed_ptrs2);
  tcase_add_test(tc_sscanf, sscanf_mixed_ptrs3);
  tcase_add_test(tc_sscanf, sscanf_mixed_ptrs4);
  tcase_add_test(tc_sscanf, sscanf_mixed_ptrs5);

  tcase_add_test(tc_sscanf, sscanf_hard1);
  tcase_add_test(tc_sscanf, sscanf_hard3);
  tcase_add_test(tc_sscanf, sscanf_hard4);
  tcase_add_test(tc_sscanf, sscanf_hard5);

  suite_add_tcase(s21_string, tc_sscanf);
  return s21_string;
}